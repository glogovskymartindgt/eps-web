...
export class AvatarInputComponent extends CustomInputComponent<string> implements OnDestroy {

    public readonly controlType: string = 'avatar';
    @HostBinding()
    public readonly id: string = `avatar-${AvatarInputComponent.nextId++}`;
    public value: string;
